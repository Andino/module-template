	...
	<div class="col-lg-12 col-md-12">
		<div id="module-app-btn-toolbar" class="section-header btn-toolbar" role="toolbar">
			<div id="module-app-btn-group-1" class="btn-group btn-group-app-toolbar">
				...
				{!! Form::button('<i class="fa fa-bug"></i> ' . Lang::get('decima-module::empleado-management.menuBug'), array('id' => 'module-app-btn-new', 'class' => 'btn btn-danger module-app-app-btn-tooltip', 'data-container' => 'body', 'data-toggle' => 'tooltip', 'data-original-title' => Lang::get('module::app.new'))) !!}
